...
public class Config
{
	...
	public static void load(LogBlock logblock) throws DataFormatException, IOException {
		...
		logblock.saveConfig();
		url = "jdbc:mysql://" + config.getString("mysql.host") + ":" + config.getInt("mysql.port") + "/" + getStringIncludingInts(config, "mysql.database") + "?useUnicode=true&characterEncoding=UTF8";
